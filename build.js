...
async function build() {
  ...
  // siteConfig — 关于我们、标签、页脚等
  lines.push('  siteConfig: {\n')
  lines.push('    hero_tag: ' + S(cfg.hero_tag) + ',\n')
  lines.push('    hero_desc: ' + S(cfg.hero_desc) + ',\n')
  lines.push('    about_label_en: ' + S(cfg.about_label_en) + ',\n')
  lines.push('    about_label_cn: ' + S(cfg.about_label_cn) + ',\n')
  lines.push('    about_subtitle_en: ' + S(cfg.about_subtitle_en) + ',\n')
  lines.push('    about_heading: ' + S(cfg.about_heading) + ',\n')
  lines.push('    about_text: ' + S(cfg.about_text) + ',\n')
  lines.push('    about_footer: ' + S(cfg.about_footer) + ',\n')
  lines.push('    about_photo: ' + S(cfg.about_photo) + ',\n')
  lines.push('    breed_label_en: ' + S(cfg.breed_label_en) + ',\n')
  lines.push('    breed_label_cn: ' + S(cfg.breed_label_cn) + ',\n')
  lines.push('    breed_subtitle_en: ' + S(cfg.breed_subtitle_en) + ',\n')
  lines.push('    dogs_label_en: ' + S(cfg.dogs_label_en) + ',\n')
  lines.push('    dogs_label_cn: ' + S(cfg.dogs_label_cn) + ',\n')
  lines.push('    dogs_subtitle_en: ' + S(cfg.dogs_subtitle_en) + ',\n')
  lines.push('    gallery_label_en: ' + S(cfg.gallery_label_en) + ',\n')
  lines.push('    gallery_label_cn: ' + S(cfg.gallery_label_cn) + ',\n')
  lines.push('    gallery_subtitle_en: ' + S(cfg.gallery_subtitle_en) + ',\n')
  lines.push('    contact_label_en: ' + S(cfg.contact_label_en) + ',\n')
  lines.push('    contact_label_cn: ' + S(cfg.contact_label_cn) + ',\n')
  lines.push('    contact_subtitle_en: ' + S(cfg.contact_subtitle_en) + ',\n')
  lines.push('    contact_heading: ' + S(cfg.contact_heading) + ',\n')
  lines.push('    contact_qr_hint: ' + S(cfg.contact_qr_hint) + ',\n')
  lines.push('    footer_text: ' + S(cfg.footer_text) + '\n')
  lines.push('  }\n')
